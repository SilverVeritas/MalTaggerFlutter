...
class AppState extends ChangeNotifier {
  ...
  String getFansubber(String originalTitle, int index, String defaultFansubber) {
  ...
  void updateAnimeFansubber(String originalTitle, String newFansubber, int index) {
  ...
  Future<void> _loadSettings() async {
    ...
    _preferredFansubber = prefs.getString('preferred_fansubber') ?? kDefaultFansubber;
  ...
  void _filterAnimeList() {
    if (_searchText.isEmpty) {
      ...
      _filteredList = _animeList
          .where((anime) => 
              anime.title.toLowerCase().contains(_searchText.toLowerCase()) ||
              (anime.alternativeTitles != null && 
               anime.alternativeTitles!.any((title) => 
    ...
    if (!_showAdult) {
      _filteredList = _filteredList.where((anime) => anime.isAdult != true).toList();
    }
  ...
  Future<void> addAnime(Anime anime) async {
    if (!_animeList.any((element) => element.malId == anime.malId)) {
      ...
      final animeToAdd = anime.fansubber.isEmpty
  ...
  Future<void> updateAnime(Anime updatedAnime) async {
    final index = _animeList.indexWhere((element) => element.malId == updatedAnime.malId);
